using Weave
#' ---
#' title : Mariners 2025 Road Trips
...
#' This season the Mariners have have 11 road trips.
#' All but one of them are multi-city.
#' The map shows the route of each trip.    
#' The legend shows the trip number and the color of the line.
#' The legend also shows the linestyle of the line.
#' - Solid: Outbound (home to first destination)
#' - Dotted: Between destinations
#' - Dashed: Return (last destination to home)
...
#' The next code chunk is executed in term mode
#+ term=true
...
#' The Mariners have 11 road trips this season.
#' All but one of them are multi-city.
#' The map shows the route of each trip.
#' The legend shows the trip number and the color of the line.
#' The legend also shows the linestyle of the line.
...
filename = normpath(@__DIR__, "src", "weaver.jmd")
